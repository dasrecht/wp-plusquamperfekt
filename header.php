...
<body <?php body_class(); ?>>
	...
	<div id="page-wrap"><!-- not needed? up to you: http://camendesign.com/code/developpeurs_sans_frontieres -->
		...
		<header id="header" class="">
			<h1 class="bigger"><a href="<?php echo get_option('home'); ?>/"><?php bloginfo('name'); ?></a></h1>
			<div class="description small">"<?php bloginfo('description'); ?>"</div>
		</header>
